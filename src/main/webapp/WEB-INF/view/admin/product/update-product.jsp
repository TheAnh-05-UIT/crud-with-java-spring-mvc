    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
            ...
            <head>
                ...
                <script>
                    $(document).ready(() => {
                        const imageFile = $("#updateImageFile");
                        imageFile.change(function (e) {
                            const imgURL = URL.createObjectURL(e.target.files[0]);
                            $("#updateImagePreview").attr("src", imgURL);
                            $("#updateImagePreview").css({ "display": "block" });
                        });
                    });
                </script>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <form:form class="row" method="POST" action="/admin/product/update"
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    <label class="form-label" for="updateImageFile">Image</label>
                                                    <input class="form-control" type="file" id="updateImageFile"
                                                        accept=".png, .jpg, .jpeg" name="updateImageFile" />
                                                </div>
                                                <div>
                                                    <img style="max-height: 250px; max-width: 600px; display: none;"
                                                        alt="image" id="updateImagePreview">
                                                </div>
